...
export const config = {
  ...
  spreadSlopeWindowMs: numberEnv(
    "SPREAD_SLOPE_WINDOW_MS",
    1_500
  ),

  maxAdverseSpreadExpansionPct: numberEnv(
    "MAX_ADVERSE_SPREAD_EXPANSION_PCT",
    0.15
  ),

  minTargetNetPct: numberEnv(
    "MIN_TARGET_NET_PCT",
    0.20
  )
} as const;
